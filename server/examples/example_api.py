...
from mediview-3d_server import mediview-3dApi, get_current_client_store, get_current_session
from mediview-3d_server.transformers import (
...
@mediview-3d.expose  # exposes as "number_trivia"
@mediview-3d.expose("get_number_trivia")  # exposes as "get_number_trivia"
...
@mediview-3d.expose("medianFilter")
