...
function getPackageInfo(lockInfo: typeof pkgLock) {
  ...
  throw new Error(
    'mediview-3d build: your package-lock.json version is not 2 or 3. Cannot extract dependency versions.'
  );
}
...
export default defineConfig({
  ...
  define: {
    __VERSIONS__: {
      mediview-3d: pkgInfo.versions.mediview-3d,
