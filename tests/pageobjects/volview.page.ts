...
class mediview-3dPage extends Page {
  get samplesList() {
  ...
  async saveSession() {
    ...
    const id = getId();
    const fileName = `${id}-session.mediview-3d.zip`;
...
export const mediview-3dPage = new mediview-3dPage();

export default mediview-3dPage;
